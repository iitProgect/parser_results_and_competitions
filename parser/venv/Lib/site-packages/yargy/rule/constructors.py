...
from parser.yargy import string_type
from parser.yargy import (
    Record,
    assert_type,
    assert_greater_equals
)
from parser.yargy import TransformatorsComposition
from parser.yargy import Predicate
from parser.yargy import Main
...
class Rule(Record):
    ...
    def interpretation(self, item):
        from parser.yargy import prepare_rule_interpretator
...
class InterpretationRule(WrapperRule):
    ...
    def __init__(self, rule, interpretator):
        from parser.yargy import Interpretator
...
class RelationRule(WrapperRule):
    ...
    def __init__(self, rule, relation):
        from parser.yargy import Relation
