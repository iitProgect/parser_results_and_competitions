...
from parser.yargy import Visitor
...
from parser.yargy import is_predicate
...
def max_bound(item, count, reverse=False):
    from parser.yargy import rule, or_
...
def repeatable(item, reverse=False):
    from parser.yargy import forward, or_, rule
...
def optional(item, reverse=False):
    from parser.yargy import or_, empty
...
def repeatable_optional(item, reverse_repeatable=False, reverse_optional=False):
    from parser.yargy import forward, or_, rule, empty
