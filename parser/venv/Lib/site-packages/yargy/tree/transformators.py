...
from parser.yargy import PipelineProduction
from parser.yargy import InterpretatorInput
...
class RelationsTransformator(InplaceTreeTransformator):
    def __init__(self):
        from parser.yargy import TokenRelationsGraph
...
class DotTreeTransformator(DotTransformator, InplaceTreeTransformator):
    def __init__(self):
        ...
        from parser.yargy import RelationsGraph
