...
from parser.parser import Visitor
...
from parser.parser import PipelineProduction
from parser.parser import InterpretatorInput
...
class RelationsTransformator(InplaceTreeTransformator):
    def __init__(self):
        from parser.parser import TokenRelationsGraph
...
class DotTreeTransformator(DotTransformator, InplaceTreeTransformator):
    def __init__(self):
        ...
        from parser.parser import RelationsGraph
