...
def test_activate():
    from parser.yargy import pipeline
    from parser.yargy import gram
    from parser.yargy import MorphTokenizer
    from parser.yargy import Context
...
def test_bnf():
    from parser.yargy import fact
    from parser.yargy import gnc_relation
